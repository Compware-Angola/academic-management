...
export default function IsentarServicosAntigos() {
  const mockData = [
    { id: 1, estudante: "Estudante Antigo 1", curso: "Medicina", servico: "Exame", valor: "15.000 Kz", isento: false },
    { id: 2, estudante: "Estudante Antigo 2", curso: "Farmácia", servico: "Certificado", valor: "8.000 Kz", isento: true },
  ];
    ...
    <div className="p-6 space-y-6">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem><BreadcrumbPage>Isentar Serviços (Estudantes Antigos)</BreadcrumbPage></BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>

      <h1 className="text-2xl font-bold">Isentar Serviços - Estudantes Antigos</h1>
      <p className="text-muted-foreground">Gerir isenções de serviços para estudantes antigos.</p>
