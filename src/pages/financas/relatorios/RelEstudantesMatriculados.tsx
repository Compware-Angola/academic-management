...
export default function RelEstudantesMatriculados() {
  const mockData = [
    { curso: "Engenharia Informática", total: 450, masculino: 320, feminino: 130 },
    { curso: "Direito", total: 380, masculino: 180, feminino: 200 },
    { curso: "Medicina", total: 120, masculino: 55, feminino: 65 },
  ];
    ...
    <div className="p-6 space-y-6">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem><BreadcrumbPage>Estudantes Matriculados</BreadcrumbPage></BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>

      <h1 className="text-2xl font-bold">Relatório - Estudantes Matriculados</h1>
      <p className="text-muted-foreground">Estatísticas de matrículas por curso.</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex gap-4">
            ...
            <Select><SelectTrigger className="w-48"><SelectValue placeholder="Semestre" /></SelectTrigger><SelectContent><SelectItem value="1">1º Semestre</SelectItem></SelectContent></Select>
          </div>
        </CardContent>
      </Card>
            ...
            <TableBody>
              {mockData.map((item, i) => (
                <TableRow key={i}>
                  ...
                  <TableCell>{item.masculino}</TableCell>
                  <TableCell>{item.feminino}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
