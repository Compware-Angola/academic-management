        ...
        <Card>
            <CardContent className="p-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                    <AcademicYearSelect onChangeValue={(v) => { setFilters((f) => ({ ...f, anoLectivo: v })); handleSetPage(1); }} value={filters.anoLectivo} enableDefaultSelectItem />
                    <SemestreSelect onChangeValue={(v) => { setFilters((f) => ({ ...f, semestre: v })); handleSetPage(1); }} value={filters.semestre} enableDefaultSelectItem />
                    <InstituicaoSelect onChangeValue={(v) => { setFilters((f) => ({ ...f, codigoInstituicao: v, codigoBolsa: "all" })); handleSetPage(1); }} value={filters.codigoInstituicao} enableDefaultSelectItem />
                    <BolsaSelect onChangeValue={(v) => { setFilters((f) => ({ ...f, codigoBolsa: v })); handleSetPage(1); }} value={filters.codigoBolsa} enableDefaultSelectItem codigoInstituicao={filters.codigoInstituicao} disabled={!filters.codigoInstituicao} />
                </div>
                                    ...
                                    <TableCell className="text-right">
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Button aria-label="Detalhes" size="icon" variant="ghost">
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Button aria-label="Editar" size="icon" variant="ghost" onClick={() => {
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <Button aria-label="Deletar" size="icon" variant="destructive" onClick={() => handleOpenDelete(r)}>
