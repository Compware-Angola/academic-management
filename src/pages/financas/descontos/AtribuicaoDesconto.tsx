...
export default function AtribuicaoDesconto() {
  const mockData = [
    { id: 1, estudante: "Ana Silva", curso: "Eng. Informática", tipoDesconto: "Funcionário", percentagem: "25%", status: "Pendente" },
    { id: 2, estudante: "Pedro Santos", curso: "Direito", tipoDesconto: "Irmãos", percentagem: "15%", status: "Aprovado" },
  ];
    ...
    <div className="p-6 space-y-6">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem><BreadcrumbPage>Atribuição de Desconto</BreadcrumbPage></BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>

      <h1 className="text-2xl font-bold">Atribuição de Desconto</h1>
      <p className="text-muted-foreground">Atribuir descontos a estudantes elegíveis.</p>
      ...
      <Card>
        <CardHeader><CardTitle>Atribuições de Desconto</CardTitle></CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
