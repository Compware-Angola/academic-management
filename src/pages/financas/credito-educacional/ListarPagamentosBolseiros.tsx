...
export default function ListarPagamentosBolseiros() {
  const mockData = [
    { id: 1, bolseiro: "Ana Silva", instituicao: "INAGBE", totalPago: "450.000 Kz", numPagamentos: 10, ultimoPagamento: "2024-01-15" },
    { id: 2, bolseiro: "Pedro Santos", instituicao: "Sonangol", totalPago: "378.000 Kz", numPagamentos: 9, ultimoPagamento: "2024-01-10" },
  ];
    ...
    <div className="p-6 space-y-6">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem><BreadcrumbPage>Listar Pagamentos de Bolseiros</BreadcrumbPage></BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>

      <h1 className="text-2xl font-bold">Listar Pagamentos de Bolseiros</h1>
      <p className="text-muted-foreground">Histórico completo de pagamentos por bolseiro.</p>
      ...
      <Card>
        <CardHeader><CardTitle>Resumo de Pagamentos</CardTitle></CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
            ...
            <TableBody>
              {mockData.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell className="font-semibold">{item.totalPago}</TableCell>
