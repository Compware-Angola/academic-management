...
//   const [solicitacaoAnexos, setSolicitacaoAnexos] =
//     useState<SolicitacaoSuporte | null>(null);
...
//         file: selectedFile,
//         options: { folder: FileFolder.SOLICITACAO },
//       });
//       const uploadedName = result.key;
...
//           {(listError as any)?.message || "Tente recarregar a página"}
//         </p>
//       </div>
//     );
//   }
...
//             Gerencie e responda às solicitações dos estudantes
//           </p>
//         </div>
//       </div>
...
//           <p>
//             Mostrando {solicitacoes.length} de {total} • Página {currentPage} de{" "}
//             {totalPages}
//           </p>
...
//                   <p className="font-medium">
//                     {solicitacaoDetail.data_mensagem}
//                   </p>
//                 </div>
...
//                                     size="sm"
//                                     onClick={() =>
//                                       handleDownload(resposta.file_name1!)
//                                     }
//                                   >
...
//                                     size="sm"
//                                     onClick={() =>
//                                       handleDownload(resposta.file_name2!)
//                                     }
//                                   >
//                                     <Download className="h-4 w-4" />
//                                   </Button>
...
//                                     size="sm"
//                                     onClick={() =>
//                                       handleDownload(resposta.file_name3!)
//                                     }
//                                   >
//                                     <Download className="h-4 w-4" />
//                                   </Button>
...
//                         const fileKey = `file${slot}` as keyof typeof files;
//                         const nameKey =
//                           `fileName${slot}` as keyof typeof fileNames;
...
//           <DialogHeader>
//             <DialogTitle>
//               Anexos da Solicitação #{solicitacaoAnexos?.contactos_id || "—"}
//             </DialogTitle>
//           </DialogHeader>
...
//             {solicitacaoAnexos &&
//               ![
//                 solicitacaoAnexos.file_name1,
//                 solicitacaoAnexos.file_name2,
//                 solicitacaoAnexos.file_name3,
//               ].some(Boolean) && (
