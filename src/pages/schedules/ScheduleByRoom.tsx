  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Horários por Sala</h1>
          <p className="text-muted-foreground">Consulte os Horários.</p>
        </div>
      </div>
                  ...
                  <TableBody>
                    {tableData.map((item) => (
                      <TableRow key={item.codigo}>
                        ...
                        <TableCell>{item.horario_nome}</TableCell>
                        <TableCell>{item.curso}</TableCell>
                        <TableCell>{item.ano}</TableCell>
                        <TableCell>{item.docente_nome}</TableCell>
                        <TableCell>{item.modalidade}</TableCell>
                        <TableCell>{item.tipo_aula}</TableCell>
