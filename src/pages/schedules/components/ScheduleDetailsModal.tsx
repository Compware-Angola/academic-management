...
export default function ScheduleDetailsModal({
  ...
  <Dialog open={isOpen} onOpenChange={closeModal}>
    <DialogContent className="w-full sm:w-[600px] md:w-[800px] lg:w-[1000px] xl:w-[1200px] max-h-[90vh] flex flex-col overflow-hidden">
                          ...
                          <div className="space-y-1.5 text-muted-foreground text-xs">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium text-foreground truncate max-w-[140px]">
                                {aula.docenteNome && aula.docenteNome !== "Sem docente"
                                  ? aula.docenteNome
                                  : "—"}
                              </span>
                            </div>
