...
import { useStudentAcademicHistoryEquivalency } from "@/hooks/students/use-query-students";
...
export function FiltrarPorEquivalencia({
  codigoMatricula,
  ...
  const { data: response, isLoading } = useStudentAcademicHistoryEquivalency({
