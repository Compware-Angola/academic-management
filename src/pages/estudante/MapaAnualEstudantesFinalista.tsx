...
export default function MapaAnualEstudantesFinalistas() {
      ...
      <GenericPDFDocument
        ...
        mainTable={{
          headers: [
            ...
            { key: "data_nascimento", label: "Data de Nascimento", width: "10%" },
            { key: "provincia", label: "Província", width: "12%" },
            { key: "municipio", label: "Município de Residncia", width: "12%" },
            { key: "pais_origem", label: "País Origem", width: "12%" },
            { key: "periodo_estudo", label: "Período de Estudo", width: "10%" },
            { key: "unidade_organica", label: "Unidade Orgânica", width: "14%" },
            { key: "curso", label: "Curso Inscrito no Ensino Superior", width: "14%" },
            { key: "ano_primeira_matricula", label: "Ano da 1ª Matrícula", width: "10%" },
            { key: "trabalhador", label: "Trabalhador", width: "10%" },
            { key: "duracao_curso", label: "Duração do  Curso", width: "8%" },
  ...
  const columns = [
    ...
    { header: "Município de Residencia", accessor: "municipio" },
    { header: "País de Origem", accessor: "pais_origem" },
    { header: "Período de Estudo", accessor: "periodo_estudo" },
    { header: "Unidade Orgânica", accessor: "unidade_organica" },
    { header: "Curso Inscrito no Ensino Superior", accessor: "curso" },
    { header: "Ano da 1ª Matrícula", accessor: "ano_primeira_matricula" },
    { header: "Trabalhador", accessor: "trabalhador" },
    { header: "Duração do Curso", accessor: "duracao_curso" },
    {
      header: "Média Final",
