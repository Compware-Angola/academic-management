...
import { GraduationCap, FileText, Calendar, Phone, Mail, MapPin } from "lucide-react";
...
export function StudentProfileHeader({ matricula }: Props) {
  ...
  const initials = student.nome_completo
    ?.trim()
    .split(/\s+/)
      ...
      <CardContent className="p-6">
        <div className="flex flex-col md:flex-row gap-6">
          <Avatar className="h-32 w-32">
            <AvatarImage src={photoUrl} alt={student.nome_completo || "Foto do estudante"} key={photoUrl} />
