...
export default function MarcarAssiduidade() {
  ...
  const marcar = async (id: number, tipo: "presente" | "ausente" | "pendente") => {
    ...
    try {
      ...
      // Atualizar localmente (optimistic update) ou refetch
...
<div className="flex items-center gap-3">
      ...
      <Button
        ...
        onClick={() => setFilters({
          ...
          unidadeCurricular: "",
          page: 1,
          limit: 10,  // ajusta para o teu valor default real
        })}
      >
        Limpar filtros
      </Button>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
   ...
   <div className="space-y-1.5">
                ...
                <FormSelect
                  ...
                  map={(opt) => opt}  // se já estás a passar objetos {key, label, value}
      ...
      <>
        ...
        <TabsContent value="provas">
          <div className="text-center py-12 text-muted-foreground">
            Em desenvolvimento — funcionalidade de provas ainda não implementada
          </div>
        </TabsContent>

        <TabsContent value="campo">
          <div className="text-center py-12 text-muted-foreground">
            Em desenvolvimento — funcionalidade de aulas de campo ainda não implementada
          </div>
        </TabsContent>
      </Tabs>
