...
import { useQueryFiltroAssiduidadeCampo } from "@/hooks/assiduidade/use-fetch-assiduidade-aula-campo";
...
import { useQueryPostGraduationAttendanceFieldSchedules } from "@/hooks/post-graduation/use-query-attendance-field-schedules";
...
} = useQueryFiltroAssiduidadeCampo(attendanceScheduleParams, {
  enabled: !isPostGraduationAttendance,
});
const {
  data: postGraduationAssiduidadeAula,
  isLoading: isLoadingPostGraduationAssiduidade,
} = useQueryPostGraduationAttendanceFieldSchedules(attendanceScheduleParams, {
  enabled: isPostGraduationAttendance,
});
