...
export function PaymentComparisonChart() {
    ...
    const labelAnoAnterior =
        monthlyPaymentComparison?.totalAnual?.anoAnterior.label ?? monthlyPaymentComparison?.mensal[0]?.label_ano_anterior ?? "Ano anterior"
    ...
    const totalValorAtual = monthlyPaymentComparison?.totalAnual?.anoAtual.totalValor ?? 0
    const totalValorAnterior = monthlyPaymentComparison?.totalAnual?.anoAnterior.totalValor ?? 0
    const totalPagamentosAtual = monthlyPaymentComparison?.totalAnual?.anoAtual.totalPagamentos ?? 0
    const totalPagamentosAnterior = monthlyPaymentComparison?.totalAnual?.anoAnterior.totalPagamentos ?? 0
