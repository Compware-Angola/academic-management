...
// ⭐ Instância Axios
// ==========================
export const axiosNestJob = axios.create({
  baseURL: import.meta.env.VITE_NEST_JOB_API_URL,
  headers: {
...
// ==========================
axiosNestJob.interceptors.request.use(
  (config) => {
...
// ==========================
axiosNestJob.interceptors.response.use(
  (response) => {
